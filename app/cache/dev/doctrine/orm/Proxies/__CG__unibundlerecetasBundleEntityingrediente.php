 ...
 */
class ingrediente extends \uni\bundle\recetasBundle\Entity\ingrediente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\ingrediente' . "\0" . 'id', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\ingrediente' . "\0" . 'nombre', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\ingrediente' . "\0" . 'descripcion', 'recingr');
        }
