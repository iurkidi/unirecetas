 ...
 */
class categoria extends \uni\bundle\recetasBundle\Entity\categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\categoria' . "\0" . 'id', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\categoria' . "\0" . 'titulo', '' . "\0" . 'uni\\bundle\\recetasBundle\\Entity\\categoria' . "\0" . 'descripcion', 'recetas');
        }
